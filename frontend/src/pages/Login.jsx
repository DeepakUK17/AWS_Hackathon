...
export default function Login() {
  ...
  const fillDemo = (role) => {
    const creds = {
      admin: ['admin@forgeos.com', 'Admin@123'],
      sales: ['sales@forgeos.com', 'Sales@123'],
      purchase: ['purchase@forgeos.com', 'Purchase@123'],
      mfg: ['mfg@forgeos.com', 'Mfg@123'],
      inventory: ['inventory@forgeos.com', 'Inv@123'],
      hr: ['hr@forgeos.com', 'Hr@123']
    };
    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-logo">
          ...
          <div>
            <h1><span>Forge</span>OS</h1>
            <p>AI Business Operating System</p>
          </div>
        </div>

        <h2 className="login-title">Welcome back</h2>
        <p className="login-subtitle">Sign in to your ForgeOS workspace</p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              ...
              placeholder="admin@forgeos.com or mylogin123"
              value={email}
        ...
        <div className="login-demo-creds">
          ...
          {['admin', 'sales', 'purchase', 'mfg', 'inventory', 'hr'].map(role => (
            <div key={role} className="demo-cred" style={{ cursor: 'pointer' }} onClick={() => fillDemo(role)}>
              ...
              <span>{role === 'mfg' ? 'mfg@forgeos.com' : `${role}@forgeos.com`}</span>
            </div>
          ))}
