/**
 * Seed file for ForgeOS — AI Business Operating System
 * Demo company: Apex Manufacturing Co.
...
async function main() {
  ...
  const users = await Promise.all([
    prisma.user.upsert({ where: { email: 'admin@forgeos.com' }, update: {}, create: { name: 'Alex Morgan (Admin)', email: 'admin@forgeos.com', password: hashedPassword, role: 'admin', position: 'Business Owner', phone: '+91-9876543210' } }),
    prisma.user.upsert({ where: { email: 'sales@forgeos.com' }, update: {}, create: { name: 'Priya Singh', email: 'sales@forgeos.com', password: await bcrypt.hash('Sales@123', 12), role: 'sales', position: 'Sales Manager', phone: '+91-9876543211' } }),
    prisma.user.upsert({ where: { email: 'purchase@forgeos.com' }, update: {}, create: { name: 'Raj Patel', email: 'purchase@forgeos.com', password: await bcrypt.hash('Purchase@123', 12), role: 'purchase', position: 'Purchase Manager', phone: '+91-9876543212' } }),
    prisma.user.upsert({ where: { email: 'mfg@forgeos.com' }, update: {}, create: { name: 'Deepak Verma', email: 'mfg@forgeos.com', password: await bcrypt.hash('Mfg@123', 12), role: 'manufacturing', position: 'Production Manager', phone: '+91-9876543213' } }),
    prisma.user.upsert({ where: { email: 'inventory@forgeos.com' }, update: {}, create: { name: 'Anita Sharma', email: 'inventory@forgeos.com', password: await bcrypt.hash('Inv@123', 12), role: 'inventory', position: 'Inventory Manager', phone: '+91-9876543214' } }),
    prisma.user.upsert({ where: { email: 'hr@forgeos.com' }, update: {}, create: { name: 'Neha Gupta', email: 'hr@forgeos.com', password: await bcrypt.hash('Hr@123', 12), role: 'hr', position: 'HR Manager', phone: '+91-9876543215' } }),
  ]);
